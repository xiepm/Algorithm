...
#define EXPORT_EXTREF_STMT \
        { (RTS_VOID_FCTPTR)updatestateestimates, "updatestateestimates", 0x0D0F1BB6, 0x01000000 },\
          ...
          { (RTS_VOID_FCTPTR)setrobotdhparameters, "setrobotdhparameters", 0xD1368FC2, 0x01000000 },\
          ...
          { (RTS_VOID_FCTPTR)setmaxpowerandmomentumconstraints, "setmaxpowerandmomentumconstraints", 0xACEB1CAA, 0x01000000 },\
          ...
          { (RTS_VOID_FCTPTR)initializecollaborativealgorithm, "initializecollaborativealgorithm", 0xDD0174E5, 0x01000000 },\
          { (RTS_VOID_FCTPTR)getsettingparameters, "getsettingparameters", 0xF699F96C, 0x01000000 },\
