...
{
	RTS_IEC_LREAL kinParams[4];		/* kinrmatics parameters. */
...
typedef void (CDECL CDECL_EXT* PFGETSETTINGPARAMETERS_IEC) (getsettingparameters_struct *p);
	...
	#define EXP_getsettingparameters  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"getsettingparameters", (RTS_UINTPTR)getsettingparameters, 1, 0xF699F96C, 0x01000000) 
#elif defined(MIXED_LINK) && !defined(ELFINCOLLABORATIVELIB_EXTERNAL)
	#define USE_getsettingparameters
	#define EXT_getsettingparameters
	#define GET_getsettingparameters(fl)  CAL_CMGETAPI( "getsettingparameters" ) 
	...
	#define EXP_ElfinCollaborativeLibgetsettingparameters  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"getsettingparameters", (RTS_UINTPTR)getsettingparameters, 1, 0xF699F96C, 0x01000000) 
#elif defined(CPLUSPLUS)
	#define USE_getsettingparameters
	#define EXT_getsettingparameters
	#define GET_getsettingparameters(fl)  CAL_CMGETAPI( "getsettingparameters" ) 
	...
	#define GET_getsettingparameters(fl)  s_pfCMGetAPI2( "getsettingparameters", (RTS_VOID_FCTPTR *)&pfgetsettingparameters, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xF699F96C, 0x01000000)
...
typedef void (CDECL CDECL_EXT* PFINITIALIZECOLLABORATIVEALGORITHM_IEC) (initializecollaborativealgorithm_struct *p);
	...
	#define EXP_initializecollaborativealgorithm  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"initializecollaborativealgorithm", (RTS_UINTPTR)initializecollaborativealgorithm, 1, 0xDD0174E5, 0x01000000) 
#elif defined(MIXED_LINK) && !defined(ELFINCOLLABORATIVELIB_EXTERNAL)
	#define USE_initializecollaborativealgorithm
	#define EXT_initializecollaborativealgorithm
	#define GET_initializecollaborativealgorithm(fl)  CAL_CMGETAPI( "initializecollaborativealgorithm" ) 
	...
	#define EXP_ElfinCollaborativeLibinitializecollaborativealgorithm  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"initializecollaborativealgorithm", (RTS_UINTPTR)initializecollaborativealgorithm, 1, 0xDD0174E5, 0x01000000) 
#elif defined(CPLUSPLUS)
	#define USE_initializecollaborativealgorithm
	#define EXT_initializecollaborativealgorithm
	#define GET_initializecollaborativealgorithm(fl)  CAL_CMGETAPI( "initializecollaborativealgorithm" ) 
	...
	#define GET_initializecollaborativealgorithm(fl)  s_pfCMGetAPI2( "initializecollaborativealgorithm", (RTS_VOID_FCTPTR *)&pfinitializecollaborativealgorithm, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xDD0174E5, 0x01000000)
...
{
	RTS_IEC_INT drivebackMode;			/* VAR_INPUT */	/* mode_PowerOff = 0,	servo off */
...
/**
 * set friction compensatory factor
 * frictionCompensatoryFactor, is decide what percentage of joints coulomb friction will compensate in assistive mode.
 * This factor setting need to be careful, because might lead to instability in assistive mode.
 */
typedef struct tagsetfrictioncompensatoryfactor_struct
{
	RTS_IEC_LREAL frictionCompensatoryFactor[6];	/* VAR_INPUT */	/* default setting: J1="0.5" J2="0.5" J3="0.4" J4="0.6" J5="0.7" J6="0.7" */
...
/**
 * set friction compensatory factor II
 * frictionCompensatoryFactor, is decide what percentage of joints coulomb friction will compensate in starting assistive mode.
 * This factor setting need to be careful, because might lead to instability in assistive mode.
 */
...
typedef void (CDECL CDECL_EXT* PFSETMAXPOWERANDMOMENTUMCONSTRAINTS_IEC) (setmaxpowerandmomentumconstraints_struct *p);
	...
	#define EXP_setmaxpowerandmomentumconstraints  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"setmaxpowerandmomentumconstraints", (RTS_UINTPTR)setmaxpowerandmomentumconstraints, 1, 0xACEB1CAA, 0x01000000) 
#elif defined(MIXED_LINK) && !defined(ELFINCOLLABORATIVELIB_EXTERNAL)
	#define USE_setmaxpowerandmomentumconstraints
	#define EXT_setmaxpowerandmomentumconstraints
	#define GET_setmaxpowerandmomentumconstraints(fl)  CAL_CMGETAPI( "setmaxpowerandmomentumconstraints" ) 
	...
	#define EXP_ElfinCollaborativeLibsetmaxpowerandmomentumconstraints  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"setmaxpowerandmomentumconstraints", (RTS_UINTPTR)setmaxpowerandmomentumconstraints, 1, 0xACEB1CAA, 0x01000000) 
#elif defined(CPLUSPLUS)
	#define USE_setmaxpowerandmomentumconstraints
	#define EXT_setmaxpowerandmomentumconstraints
	#define GET_setmaxpowerandmomentumconstraints(fl)  CAL_CMGETAPI( "setmaxpowerandmomentumconstraints" ) 
	...
	#define GET_setmaxpowerandmomentumconstraints(fl)  s_pfCMGetAPI2( "setmaxpowerandmomentumconstraints", (RTS_VOID_FCTPTR *)&pfsetmaxpowerandmomentumconstraints, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xACEB1CAA, 0x01000000)
...
/**
 * set Elfin's DH parametesr, only include link length
 */
typedef struct tagsetrobotdhparameters_struct
{
	RTS_IEC_LREAL kinematcisParam[4];	/* VAR_INPUT */	/* [d1  d4 d6 a2] unit(millimeter) */
	RTS_IEC_BOOL setRobotDHParameters;	/* VAR_OUTPUT */	
} setrobotdhparameters_struct;

void CDECL CDECL_EXT setrobotdhparameters(setrobotdhparameters_struct *p);
typedef void (CDECL CDECL_EXT* PFSETROBOTDHPARAMETERS_IEC) (setrobotdhparameters_struct *p);
#if defined(ELFINCOLLABORATIVELIB_NOTIMPLEMENTED) || defined(SETROBOTDHPARAMETERS_NOTIMPLEMENTED)
	#define USE_setrobotdhparameters
	#define EXT_setrobotdhparameters
	#define GET_setrobotdhparameters(fl)  ERR_NOTIMPLEMENTED
	#define CAL_setrobotdhparameters(p0) 
	#define CHK_setrobotdhparameters  FALSE
	#define EXP_setrobotdhparameters  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_setrobotdhparameters
	#define EXT_setrobotdhparameters
	#define GET_setrobotdhparameters(fl)  CAL_CMGETAPI( "setrobotdhparameters" ) 
	#define CAL_setrobotdhparameters  setrobotdhparameters
	#define CHK_setrobotdhparameters  TRUE
	#define EXP_setrobotdhparameters  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"setrobotdhparameters", (RTS_UINTPTR)setrobotdhparameters, 1, 0xD1368FC2, 0x01000000) 
#elif defined(MIXED_LINK) && !defined(ELFINCOLLABORATIVELIB_EXTERNAL)
	#define USE_setrobotdhparameters
	#define EXT_setrobotdhparameters
	#define GET_setrobotdhparameters(fl)  CAL_CMGETAPI( "setrobotdhparameters" ) 
	...
	#define EXP_setrobotdhparameters  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"setrobotdhparameters", (RTS_UINTPTR)setrobotdhparameters, 1, 0xD1368FC2, 0x01000000) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_ElfinCollaborativeLibsetrobotdhparameters
	#define EXT_ElfinCollaborativeLibsetrobotdhparameters
	#define GET_ElfinCollaborativeLibsetrobotdhparameters  ERR_OK
	#define CAL_ElfinCollaborativeLibsetrobotdhparameters  setrobotdhparameters
	#define CHK_ElfinCollaborativeLibsetrobotdhparameters  TRUE
	#define EXP_ElfinCollaborativeLibsetrobotdhparameters  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"setrobotdhparameters", (RTS_UINTPTR)setrobotdhparameters, 1, 0xD1368FC2, 0x01000000) 
#elif defined(CPLUSPLUS)
	#define USE_setrobotdhparameters
	#define EXT_setrobotdhparameters
	#define GET_setrobotdhparameters(fl)  CAL_CMGETAPI( "setrobotdhparameters" ) 
	...
	#define EXP_setrobotdhparameters  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"setrobotdhparameters", (RTS_UINTPTR)setrobotdhparameters, 1, 0xD1368FC2, 0x01000000) 
#else /* DYNAMIC_LINK */
	#define USE_setrobotdhparameters  PFSETROBOTDHPARAMETERS_IEC pfsetrobotdhparameters;
	#define EXT_setrobotdhparameters  extern PFSETROBOTDHPARAMETERS_IEC pfsetrobotdhparameters;
	#define GET_setrobotdhparameters(fl)  s_pfCMGetAPI2( "setrobotdhparameters", (RTS_VOID_FCTPTR *)&pfsetrobotdhparameters, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xD1368FC2, 0x01000000)
	#define CAL_setrobotdhparameters  pfsetrobotdhparameters
	#define CHK_setrobotdhparameters  (pfsetrobotdhparameters != NULL)
	#define EXP_setrobotdhparameters   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"setrobotdhparameters", (RTS_UINTPTR)setrobotdhparameters, 1, 0xD1368FC2, 0x01000000) 
#endif
